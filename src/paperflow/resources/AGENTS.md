...
- `00-Research-Areas/` names what this researcher is actually working on. Keep it current: optional batch triage reads it together with `04-Questions/` to judge relevance and internal processing depth.
